...
argument-hint: "[optional: deploy method or notes]"
---
...
Read @SKILL.md, the current resume note at `/memories/session/<project>-audit-resume.md`, then execute @workflows/deploy.md.
