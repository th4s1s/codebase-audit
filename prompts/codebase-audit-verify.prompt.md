...
Read [SKILL.md](../SKILL.md), the resume note (`/memories/session/<project>-audit-resume.md`), and the live-instance note (`/memories/repo/<project>-live-instance.md`). Then execute [workflows/verify.md](../workflows/verify.md).

Findings assigned to this fork: ${input:findings:Comma-separated finding IDs (e.g., G1-F1,G1-F2,G2-F5)}
